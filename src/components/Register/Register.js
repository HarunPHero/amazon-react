...
const Register = () => {
  return (
    <div>
      <form className="shadow-lg p-3 mb-5 bg-body rounded m-5 login-form">
          ...
          <div className="col-sm-10">
            <input type="text" className="form-control" id="inputtext"required />
          </div>
        </div>
        <div className="row mb-3">
    ...
    <div className="col-sm-10">
      <input type="email" className="form-control" id="inputEmail3" required/>
        ...
        <br />
        <br />
        <button className="btn btn-primary text-light text-center">
          <svg
            aria-hidden="true"
